...
//						alert($(this).attr("name"))
    ...
    var chart = "";
    chart += "<div class=\"detail\"><span class=\"box\">省：<span id=\"province\"></span></span><span class=\"box\">市：<span id=\"city\"></span></span><span class=\"box\"style=\"padding-right:0px;\">区：<span id=\"area\"></span></span>"
    chart += '<div class=\"det\" style=\"position:relative;padding-top:5px\"><span  id="export" style=\"position: absolute;bottom: 13px;right:5px;border:1px solid #eee;z-index: 1000;padding: 3px 5px;border-radius: 3px;cursor: pointer\">导出Excel</span><span  id="changeTable" style=\"position: absolute;bottom: 13px;right:85px;border:1px solid #eee;z-index: 1000;padding: 3px 5px;border-radius: 3px;cursor: pointer\">图表切换</span><table id="rainTable" class="table2" border="0" cellspacing="0" cellpadding="0"">\
		<tr>\
...
//时序图与表格数据的切换
    ...
    //
		////出现截图
    //    yxMapClick = false;
    //    var eleOutside = $(".select").siblings(".change").find("input[name=radioButton]:checked").siblings().html()
    //    //初始化默认值
    //    var today = new Date();
    //    $(".uiMain").html(today.format("yyyy-MM-dd"));
    ...
    //    var indexOutside = 0;
    //    var shixiaoIndex = 3;
    //    if (eleOutside.indexOf("降水") != -1) {
    //        indexOutside = 0;
    //    } else if (eleOutside.indexOf("风场") != -1) {
    //        indexOutside = 1;
    //    } else if (eleOutside.indexOf("高温") != -1) {
    //        indexOutside = 2;
    //    } else if (eleOutside.indexOf("低温") != -1) {
    //        indexOutside = 3;
    //    }
    //
    //    if (eleOutside.indexOf("3H") != -1) {
    //        shixiaoIndex = 0;
    //    } else if (eleOutside.indexOf("6H") != -1) {
    //        shixiaoIndex = 1;
    //    } else if (eleOutside.indexOf("12H") != -1) {
    //        shixiaoIndex = 2;
    //    } else if (eleOutside.indexOf("24H") != -1) {
    //        shixiaoIndex = 3;
    //    }
    //
    //    $(".selectElement_radioTime").eq(shixiaoIndex).children("input").attr("checked", true);
    //
    //
    //    $(".selectElement_span").eq(indexOutside).trigger("click");
    //    //显示影响预报
    //    $(".selectElementBox").show();
    //
    //
    //    //若是时序图显示的话  使之缩回  并且使鼠标提示信息以及点击提示信息消失
    //    if (!quxiaoFlag) {
    //        //取消时序图
    ...
    //
		...
		//	$(".yxFooter").css({"display":"none","bottom":0});
		//	$(".main_title1").css({"right":"0"});
		//	$(".Universal_tool").css({"right":"0"});
		//	$(".footer").css({"display":"block"});
		//	$("#showLat").css({"right":"203px"});
		//	$(".selectElementBox").hide();
		//	map.removeLayer(geojsonLayer);
		//	yxMapClick = true;
		//	//var web=document.getElementById("web");
		//	//var parent=document.getElementsByClassName("yxFooter")[0];
		//	//parent.appendChild(web);
		//	//$(".yxFooter #web").css({"display":"block"});
    //    });
    //    //点击出现日历
...
////影响预报
////加载影响预报以及API数据
//    var influenceForecast = "";
//    influenceForecast += '<div class="selectElement_box" style="padding-top: 10px;"><div style="width:100%;height:40px;font-size: 12px"><span style="display: inline-block;line-height: 20px;font-size: 14px;border: 1px solid #000;border-right:0px;margin-left: 10px">';
//    for (var i = 0; i < elementData.length; i++) {
//        //console.log(elementData.length);
//        if (elementData[i].children == null) {
//            influenceForecast += '<span class="selectElement_span" style="width:40px;height: 20px;border-right: 1px solid #000;" onclick="\"><span class="ele" style="display:inline-block;width:100%;text-align:center;">' + elementData[i].name + '</span></span>';
//
//        } else {
//            var data = elementData[i].children;
//            influenceForecast += '<span class="selectElement_span" style="width:40px;height: 20px;border-right: 1px solid #000;" onclick="\"><span class="ele" style="display:inline-block;width:100%;text-align:center;">' + elementData[i].name + '</span><span style="position:absolute;top:30px;left:0;display: inline-block;line-height: 20px;font-size: 14px;margin-top: 5px">';
//            for (var j = 0; j < elementData[i].children.length; j++) {
//                influenceForecast += '<span class="selectElement_radioTime" style="width:50px;height: 20px;text-align:center;"><input type="radio" name="radioTime"/><span>' + data[j].name + '</span></span>'
//            }
//
//            influenceForecast += '</span></span>';
//        }
//    }
////<div class="showEchartsBox">
//    influenceForecast += '</span></div>\
//        <div class="zongShu" style="position:absolute;top:65px;left:0px;width: 100%;height:94px;border: 1px solid #000;border-right: 0;border-left: 0;"><p style="font-weight:bold;text-indent:10px;font-size:14px;display: inline-block;width: 100%;height:25px;line-height: 25px;background:rgba(41,50,55,.5);color: #fff;">影响预报</p><div class="zongzhuTable"style="width:100%;height: 70px;overflow-y: scroll;">\
//        <p style="text-indent:10px;"></p>\
//        </div></div>\
//        <div class="showEchartsBox" style="position:absolute;top:165px;left:0px;"><p style="font-weight:bold;text-indent:10px;font-size:14px;display: inline-block;width: 100%;height:25px;line-height: 25px;background:rgba(41,50,55,.5);color: #fff;">图表展示</p><div class="showEcharts" style="">\
//        <div class="echartsContentBox" style="width: 240px;height: 173px;float:left;">\
//          <table id="echartsContent"  width="223px" ></table>\
//          <div style="width:100%;height:151px;overflow-y:scroll;float: left;">\
//            <table id="echartsContent2"  width="100%" ></table>\
//          </div>\
//        </div>\
//        <div id="tableEcharts1" style="display: inline-block;width: 410px;height: 173px;float:left;">\
//        </div>\
//        </div></div>\
//        <div class="showEchartsBox" style="position:absolute;bottom:-16px;left:0px;"><div class="showEcharts" style="">\
//        <div class="echartsContentBox1" style="width: 240px;height: 173px;float:left;">\
//          <table id="echartsContent1"  width="223px" ></table>\
//          <div style="width:100%;height:151px;overflow-y:scroll;float: left;">\
//             <table id="echartsContent3"  width="100%" ></table>\
//          </div>\
//        </div>\
//        <div id="tableEcharts2" style="display: inline-block;width: 410px;height: 173px;float:left;">\
//        </div>\
//        </div></div>\
//       </div>\
//    <div class="tipLable" style="width:250px;height:60px;position:absolute;top:230px;right:0;left:0;bottom:0;margin:0 auto;background: #e2e6f2;color:#000;display:none;"></div><div class="close"><b></b></div><div style="position:absolute;top:10px;right:0px;width:150px;font-size: 12px"><span style="display: inline-block;float:left;">选择日期:</span><div class="uiMain" style="float:left;width:80px;height:20px;border:1px solid #eee;text-align:center;line-height: 20px;"></div></div><div class="ui-hover-panel" style="position:absolute;top:62px;right:10px;display: none;">\
//        <div class="easyui-calendar" id="calendarAverage" style="width:320px;height:280px;"></div></div>\
//    </div><div id="selectPrescription"  style="position:absolute;top:33px;right: 30px;width:120px;font-size: 12px;"><span>选择时效：</span><select name="prescription" id="prescription">';
//    for (var i = 0; i < elementData[0].children[0].time.length; i++) {
//        influenceForecast += '<option value="' + elementData[0].children[0].time[i] + '">' + elementData[0].children[0].time[i] + '</option>';
//    }
//    influenceForecast += '</select></div>';
//    $(".selectElement").html(influenceForecast);
...
//
//
//        var selectData = matchName(obj, objRadio);
...
//        //落区请求的是路径
//        var apiUrl = getApiUrl(selectData, urlTime, shixiao);
//        //console.log(apiUrl)
//        $.ajax({
//            url: apiUrl,
//            type: 'GET',
...
//                            }
//                        }).addTo(map);
//                        var influenceInfo = changeWebUrl(result.features);
//                        influenceInfo = influenceInfo.split("--");
//                        //解决同步异步  逐条去查
//                        when.all(getAllData(influenceInfo)).then(function (result) {
//                            //填充表格以及站点表格
//                            addData(result);
//
//                        });
...
//    var today=new Date();
//    $(".uiMain").html(today.format("yyyy-MM-dd"));
//    $(".selectElement_radioTime").eq(0).children("input").attr("checked",true);
//
//$(".selectElement_radioTime").live("click",function(){
//    $(this).children("input").attr("checked",true)
//});
//    $(".forecast").click(function(){
//        $(".selectElement_span").eq(0).trigger("click");
//        //$("#echartsContent3 tr").eq(0).trigger("click");
//    })
//    $(".selectElementBox .close").click(function(){
//        map.removeLayer(geojsonLayer);
//    })
...
//    }
//
//    function getAllData(influenceInfo) {
//        var deferreds = [];
//        for (var k = 0; k < influenceInfo.length; k++) {
//            var url = influenceInfo[k];
//            //console.log(url);
//            deferreds.push(loadUrl(url));
//        }
//        return deferreds;
//    }
//
//
////获取api的url
//    function getApiUrl(lujing, obj, time) {
...
//
////匹配要素  时效
//    function matchName(obj, objRadio) {
//        for (var i = 0; i < elementData.length; i++) {
...
//
////影响落区转换为对应的url
//    function changeWebUrl(result) {
//        var url = "";
//        for (var i = 0; i < result.length; i++) {
//            var geometries = result[i].geometry;
//            if (i == result.length - 1) {
//                url += matchCoorUrl(geometries.coordinates);
//            } else {
//                url += matchCoorUrl(geometries.coordinates) + "--";
//            }
//
...
//
//    //给表格添加数据  想试试时序图
//    function addData(result, myChart3) {
//        //影响预报综合描述中的值
...
//            }
//            if (obj == "低温") {
//                var str = obj + "<=" + level + unit + "的落区影响范围包括：" + administrativeCodeName.slice(0, -1) + "等" + xZhZong + "个县市；人口总数为：" + renkouZong.toFixed(2) + "万；GDP总数为：" + gdpZong.toFixed(2) + "亿元；站点总数为：" + stationNum1 + "个；<span class=\"shuiku\" style=\"cursor:pointer;text-decoration: underline\">水库总数为：" + shuikuZong + "座</span>；<span class=\"heliu\" style=\"cursor:pointer;text-decoration: underline\">河流总数为：" + heliuZong + "条</span>。";
//
//            } else {
//                var str = obj + ">=" + level + unit + "的落区影响范围包括：" + administrativeCodeName.slice(0, -1) + "等" + xZhZong + "个县市；人口总数为：" + renkouZong.toFixed(2) + "万；GDP总数为：" + gdpZong.toFixed(2) + "亿元；站点总数为：" + stationNum1 + "个；<span class=\"shuiku\" style=\"cursor:pointer;text-decoration: underline\">水库总数为：" + shuikuZong + "座</span>；<span class=\"heliu\" style=\"cursor:pointer;text-decoration: underline\">河流总数为：" + heliuZong + "条</span>。";
//
//            }
//            var shuikuming = "该落区影响的水库包括：" + shuiku.slice(0, -1) + "。";
//            var heliuming = "该落区影响的河流包括：" + heliu.slice(0, -1) + "。";
//            if (shuikuZong == 0) {
...
//        new_shuzu.sort(by("renkou"));
//
//        add2(3, new_shuzu);
//        //console.log(new_shuzu.sort(by1("renkou")))
//        //以升序的顺序显示人口和GDP的echarts
//        showEchartTable(new_shuzu.sort(by1("renkou")));
//
//        //填充到站点的数据表格中
//        add3(4, zhandian);
//        //点击站点td出现时序图
...
//                success: function (result) {
//                    //显示站点数据形成的echarts
//                    showEchartTable2(result, myChart4, name, stationid);
//                }
//            })
//        })
//        //默认选中站点中第一个的值
...
//            //console.log(gdp);
//            //console.log(popular);
//            //console.log(optionTableOne);
//            optionTableOne.series[0].data = popular;
//            //console.log(popular);
//            //console.log(gdp)
//            optionTableOne.series[1].data = gdp;
//
//            optionTableOne.xAxis.data = popular;
//            //console.log(optionTable1.xAxis.data)
//            optionTableOne.yAxis.data = county;
//            var bili;
//            //console.log(county.length)
//            if (county.length <= 5) {
//                optionTableOne.dataZoom[0].start = 0;
//            } else if (county.length > 5 && county.length <= 10) {
//                optionTableOne.dataZoom[0].start = 50;
//            } else {
//                bili = (5 / county.length * 100).toFixed(0);
//                optionTableOne.dataZoom[0].start = 100 - bili;
//            }
//
//
//            myChart3.setOption(optionTableOne);
...
//
////显示table中的站点的时序图
//    function showEchartTable2(obj, mychart4, name, stationid) {
...
//                    optionTable2.legend.data[0] = "降水量";
//                    optionTable2.xAxis[0].data = obj[0].data.category;
//                    optionTable2.xAxis[0].interval = 4;
//
//                    optionTable2.yAxis[0] = {
//                        type: 'value',
//                        //name: '水量',
//                        min: 0,
//                        //max: 25,
...
//                        },
//                        //markLine: {
//                        //    data:[{yAxis:result[0].extremeValue/100, name: '极值'}]
//                        //    //data: [resultExtremeValue[0].extremeValue],
//                        //}
//                    }
//                    optionTable2.series[0].name = "降水量";
//                    optionTable2.series[0].type = 'bar';
//                    optionTable2.series[0].data = obj[0].data.data;
//                } else if (element == "高温") {
//                    jizhi = "建站以来日极值：" + result[1].extremeValue + "°C";
//                    optionTable2.legend.data[0] = "高温";
//                    optionTable2.xAxis[0].data = obj[1].data.category;
...
//                        },
//                        //markLine: {
//                        //    data:[{yAxis:result[1].extremeValue, name: '极值'}]
//                        //    //data: [resultExtremeValue[0].extremeValue],
//                        //    //data:[[{value:result[1].extremeValue, name: '极值',x:0,y:100}]]
//                        //
//                        //}
//                    }
//                } else if (element == "低温") {
...
//
//                    optionTable2.legend.data[0] = "低温";
//                    //optionTable2.xAxis[0].interval =1;
//                    optionTable2.xAxis[0].data = obj[2].data.category;
//
//                    optionTable2.yAxis[0] = {
//                        type: 'value',
//                        //name: '温度',
...
//                        },
//                        //markLine: {
//                        //    data:[{yAxis:result[2].extremeValue, name: '极值'}]
//                        //    //data: [resultExtremeValue[0].extremeValue],
//                        //}
//                    }
//                }
//                optionTable2.title.text = "站点影响统计--" + name.replace(/ /g, "") + "   " + jizhi;
//
//                mychart4.setOption(optionTable2);
//            },
//            error: function (XMLHttpRequest, textStatus, errorThrown) {
//                console.error("加载数据失败")
//            }
    ...
    if (nwfdData != null) {
        ...
        for (var i = 0, m = nwfdData.length; i < m; i++) {
            ...
            if (features.children.length > 1) {
                ...
                shtml += "<div class=\"change index01 floatL\" style=\"display: none;\">";
            ...
            $("#navpanel" + (i + 1)).live("click", function () {
                ...
                if (isMobile()) {
                    ...
                    var height = 49;
								...
								//console.log(height)
                $(".index_menu_right").css("top", (parseInt(index) - 1) * height + 26 + "px");
										...
										$.ajax({
											...
											success: function (result) {
												if(result.status=="success"){
													...
													//Response.Cookies("loginname").Expires=DateAdd("S",1,now())  //'指定cookie保存时间
													//cookie.setMaxAge(1*1);
													//Response.Cookies("loginpwd").Expires=DateAdd("S",1,now())  //'指定cookie保存时间
